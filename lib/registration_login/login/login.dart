...
import 'package:flutter_demo1/registration_login/login/login_controller.dart';
import 'package:flutter_demo1/registration_login/registration/registration.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              customTextFormField(
                  controller: LoginPageController().usernameTXT,
                  hint: '@gmail.com',
                  label: 'Username',
                  leadingIcon: Icons.person,
                  validator: (value) => emptyValidation(value: value)),
              customTextFormField(
                  controller: LoginPageController().passwordTXT,
                  hint: '****',
                  label: 'Password',
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Registration_home()),
                        );
                      },
